...
class edgeR(Step):
    ...
    def impInitIO(self,):
        ...
        self.setOutputDir1To1('edgeRResult',outputpath, 'Deseq2Result','csv','matrixdata')
        ...
        self.setOutputDir1To1('EDheatmap',outputpath, 'DEheatmap','png','matrixdata')
        #set R script
        self.setInputRscript('Rscript', 'edgeR.R')
